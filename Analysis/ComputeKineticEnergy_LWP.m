...
for i = 11:dataLen
    prev_posX = f_pegData(i-10,1);
    prev_posY = f_pegData(i-10,2);
    prev_posZ = -1.*f_pegData(i-10,3);

    prev_angX = -f_pegData(i-10,6);
    prev_angY = -f_pegData(i-10,5);
    prev_angZ = -f_pegData(i-10,4);
    ...
    trans_curr = Ry_curr*Rx_curr*Rz_curr*T_curr; 
